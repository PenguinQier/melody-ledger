...
import (
	userModel "github.com/PenguinQier/melody-ledger/ZJ_BlogProject/internal/modules/user/models"
...
func (userRepository *UserRepository) Update(user userModel.User) userModel.User {
